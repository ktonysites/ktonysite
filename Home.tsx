/*
 * Signal / Surface: neo-editorial portfolio composition for Ktony Sites.
 * Use asymmetry, technical labels, lime highlights, and short physical interactions.
 */
    ...
    <div className="min-h-screen overflow-x-hidden bg-[#f7f8f5] text-[#16212b]">
      <header className={`absolute inset-x-0 top-0 z-40 text-[#f7f8f5] transition-[background-color,box-shadow,backdrop-filter] duration-300 ${scrolled ? "bg-[#16212b]/95 shadow-[0_8px_24px_rgba(22,33,43,0.16)] backdrop-blur-md" : "bg-[#16212b]"}`}>
        <div className="container flex min-h-[76px] items-center justify-between border-b border-[#f7f8f5]/15">
          <a href="#top" aria-label="Ktony Sites home" className="group flex items-center gap-3">
            ...
            <span className="font-mono text-[11px] uppercase tracking-[0.16em]">Ktony Sites</span>
          </a>
      ...
      <main>
        <section id="top" className="relative overflow-hidden bg-[#16212b] pt-[76px] text-[#f7f8f5]">
          ...
          <div className="container relative grid min-h-[calc(100vh-76px)] items-center gap-14 pb-24 pt-16 lg:grid-cols-[0.94fr_1.06fr] lg:gap-10 lg:pb-20 lg:pt-20">
            <div className="relative z-10 max-w-3xl">
              ...
              <div className="hero-actions reveal-up reveal-up-delay-3 mt-10 flex flex-wrap items-center gap-3">
              ...
              <div className="reveal-up reveal-up-delay-3 mt-14 grid gap-4 border-t border-[#f7f8f5]/15 pt-5 font-mono text-[10px] uppercase tracking-[0.12em] text-[#f7f8f5]/45 sm:flex sm:flex-wrap sm:gap-x-9 sm:gap-y-3">
            ...
            <div className="relative flex min-h-[320px] items-center justify-center sm:min-h-[420px] lg:min-h-[620px]">
        ...
        <section id="profile" className="reveal-section paper-noise relative scroll-mt-8 overflow-hidden bg-[#f7f8f5] py-24 sm:py-32">
          ...
          <div className="container">
            <div className="grid gap-14 lg:grid-cols-[0.35fr_0.65fr] lg:gap-20">
              ...
              <div className="max-w-4xl">
                ...
                <div className="mt-10 grid gap-8 text-[17px] leading-8 text-[#5f7480] md:grid-cols-[1fr_0.8fr] md:gap-14">
                  <p>
                    Your website should help the right people understand what you offer, trust your business, and know what to do next. I bring together clear content, purposeful visual design, and dependable frontend development so the path from first visit to enquiry feels natural.
                  </p>
                  <p className="text-[#16212b]/65">
                    You get a technical partner based in Nairobi who looks beyond the homepage, considering responsive behavior, accessibility, performance, and security-minded details that make your digital presence feel reliable.
                  </p>
                </div>
            ...
            <div className="mt-14 grid gap-px border border-[#16212b]/15 bg-[#16212b]/15 sm:grid-cols-3">
              {[
                ["01", "Clearer message", "Turn what you do into a reason to care."],
                ["02", "Better momentum", "Give visitors a confident next step."],
                ["03", "Built to last", "A responsive foundation you can grow into."],
              ].map(([number, title, text]) => (
                <div key={number} className="bg-[#f7f8f5] p-5 sm:p-6">
                  <span className="font-mono text-[10px] tracking-[0.14em] text-[#5f7480]">{number} / FOCUS</span>
                  <h3 className="mt-8 text-xl font-semibold tracking-[-0.04em]">{title}</h3>
                  <p className="mt-2 text-sm leading-6 text-[#16212b]/60">{text}</p>
                </div>
              ))}
            </div>
              ...
              {capabilities.map((capability, index) => {
                ...
                return (
                  <article key={capability.index} className={`group relative py-8 md:px-7 md:py-10 ${index < capabilities.length - 1 ? "border-b border-[#16212b]/20 md:border-b-0 md:border-r" : ""}`}>
                    ...
                    <h3 className="mt-12 max-w-[10ch] text-2xl font-semibold leading-[1.05] tracking-[-0.04em] md:mt-16">{capability.title}</h3>
        ...
        <section id="contact" className="reveal-section relative scroll-mt-8 overflow-hidden border-t border-[#16212b]/20 bg-[#f7f8f5] py-24 sm:py-32">
          ...
          <div className="container relative">
            ...
            <div className="mt-24 flex flex-col justify-between gap-8 border-t border-[#16212b]/25 pt-5 font-mono text-[10px] uppercase tracking-[0.14em] sm:flex-row sm:items-center">
              ...
              <div className="flex items-center gap-5"><a href="https://github.com" target="_blank" rel="noreferrer" className="transition-opacity hover:opacity-60">GitHub</a><a href="https://linkedin.com" target="_blank" rel="noreferrer" className="transition-opacity hover:opacity-60">LinkedIn</a><span className="text-[#16212b]/55">© Ktony Sites / 2026</span></div>
            </div>
          </div>
        </section>
      </main>
            ...
            {!submitted ? (
              <form onSubmit={handleContactSubmit}>
                ...
                <div className="mt-8 grid gap-5 sm:grid-cols-2">
                  <label className="font-mono text-[10px] uppercase tracking-[0.12em] text-[#5f7480]">Your name<input required name="name" className="mt-2 block w-full border-b border-[#16212b]/30 bg-transparent px-0 py-3 text-base font-sans normal-case tracking-normal text-[#16212b] outline-none placeholder:text-[#16212b]/35 focus:border-[#5f7480]" placeholder="Your name / team / studio" /></label>
                ...
                <div className="mt-8 flex flex-wrap items-center justify-between gap-4"><span className="max-w-xs font-mono text-[9px] uppercase tracking-[0.1em] text-[#16212b]/45">Submitting opens your email app with the enquiry addressed to Ktony Sites.</span><button type="submit" className="button-ink">Send the brief <ArrowUpRight size={15} /></button></div>
              </form>
            ) : (
              <div className="py-8"><div className="flex size-12 items-center justify-center bg-[#c6d45a]"><Check size={22} /></div><h2 id="contact-dialog-title" className="mt-7 text-4xl font-semibold tracking-[-0.06em]">Message received.</h2><p className="mt-4 max-w-md text-base leading-7 text-[#16212b]/65">Your email app should now have a ready-to-send enquiry for Ktony Sites at ktony7854@gmail.com. If it did not open, email the brief directly from your inbox.</p><button type="button" className="button-ghost mt-8" onClick={() => setContactOpen(false)}>Close panel <X size={14} /></button></div>
            )}
          </div>
        </div>
      )}
